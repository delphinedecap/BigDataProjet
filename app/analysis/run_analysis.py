...
def get_paths():
    return {
        ...
        "rewrite_fr_unspecific": os.path.join(
            DATA_DIR,
            "variant_rewrite_fr_unspecific_output.jsonl"
        ),
        "rewrite_fr_specific": os.path.join(
            DATA_DIR,
            "variant_rewrite_fr_specific_output.jsonl"
        ),

        "rewrite_en_unspecific": os.path.join(
            DATA_DIR,
            "variant_rewrite_en_unspecific_output.jsonl"
        ),
        "rewrite_en_specific": os.path.join(
            DATA_DIR,
        ...
        "neutral_fr_unspecific": os.path.join(
            DATA_DIR,
            "fr_unspecific_neutral_output.jsonl"
        ),
        "neutral_fr_specific": os.path.join(
            DATA_DIR,
            "fr_specific_neutral_output.jsonl"
        ),

        "neutral_en_unspecific": os.path.join(
            DATA_DIR,
            "en_unspecific_neutral_output.jsonl"
        ),
        "neutral_en_specific": os.path.join(
            DATA_DIR,
        ...
        "cultural_fr_unspecific": os.path.join(
            DATA_DIR,
            "fr_unspecific_cultural_output.jsonl"
        ),
        "cultural_fr_specific": os.path.join(
            DATA_DIR,
            "fr_specific_cultural_output.jsonl"
        ),

        "cultural_en_unspecific": os.path.join(
            DATA_DIR,
            "en_unspecific_cultural_output.jsonl"
        ),
        "cultural_en_specific": os.path.join(
            DATA_DIR,
